...
> **Publish dei 5 (GO owner) TENTATO ma NON riuscito:** costi reali AutoDS verificati e **sani** (buy $4.98–$11.11 → sell $14.97–$21.97, profit ~$7 ciascuno, in stock); ma il publish automatico (card Import) non si completa — i 5 restano draft (count 14), nessuno in /products dopo settle. = **instabilità publish AutoDS** (i draft Amazon stamattina pubblicavano; questi 5 AliExpress no). **I 5 sono pronti** (titolo+descrizione+costo OK) → **pubblicarli a mano nella UI AutoDS** (gestisce l'eventuale step variante/spedizione che l'automazione salta).
>
