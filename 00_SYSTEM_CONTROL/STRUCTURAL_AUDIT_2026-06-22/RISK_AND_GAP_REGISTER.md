...
| R4 | MED (firewall) | Other-domain residue inside this eBay machine: ~~`10_OUTPUTS/n8n_digital_products/` (Stripe/digital-product delivery)~~, `00_SYSTEM_CONTROL/PLAYBOOKS/n8n_workflows/03_shopify_daily_snapshot.json` | scan | **PARTIALLY CLOSED 2026-09-08** — owner GO: n8n folder archived to `99_ARCHIVE/MISPLACED__n8n_digital_products/`. The Shopify workflow half is **still OPEN** (no GO given). |
