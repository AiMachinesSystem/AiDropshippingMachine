...
| Data | Run | Verdetto |
|---|---|---|
| 2026-06-29 | **Profit run (`dropship-profit-run`): catalogo live NON-profittevole (costo ≥ market), demand-first = via** | Audit per-SKU: **220 attivi, solo 4 con vendite (11 u)** (`total_sold_count` azzerato da KILL+ripubblica + inaffidabile post-trial). Sold-comp eBay reale: **prezzi 2.5×–3.75× SOPRA market; costo Amazon ≥ prezzo eBay in 5/6** (Deck Jet $96.46 vs $36.78 market). Reprice-to-market = perdita → non fatto. **Domanda reale in stagione (ceiling net≥$4):** Hot Tub Cover 495 sold ($50.64) · Chlorine 73 ($39.31) · Patio cover 50 ($21.23) · Skimmer 46 ($3.30) · Deck Jet 31 ($21.91). Strategia presa = **demand-first sourcing** sotto i ceiling; se retail non regge → wholesale/private-label (capitale). 5ª conferma [[retail-dropship-margin-dead]]. |
